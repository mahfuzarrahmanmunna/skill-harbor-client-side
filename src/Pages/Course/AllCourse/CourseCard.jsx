    ...
    return (
        <Fade>
            <motion.div
                ...
                whileTap={{ scale: 0.97 }}
            >
                <div className="max-w-sm p-6 rounded-2xl shadow-xl bg-white/80 dark:bg-slate-800 dark:text-white backdrop-blur-md transition-all duration-300 hover:shadow-2xl border border-slate-200 dark:border-slate-700">
                    <img
                        src={image}
                        alt={title}
